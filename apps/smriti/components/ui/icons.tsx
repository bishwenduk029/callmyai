...
export function IconGoogle({
  ...
  return (
    ...
    >
      <title>Google</title>
      <g clip-path="url(#clip0_461_8709)">
        <path
          d="M23.7682 12.2743C23.7682 11.4586 23.7021 10.6384 23.561 9.83594H12.2422V14.4569H18.7239C18.455 15.9473 17.5907 17.2657 16.3252 18.1034V21.1018H20.1922C22.463 19.0118 23.7682 15.9252 23.7682 12.2743Z"
          fill="#4285F4"
        ></path>
        <path
          d="M12.2391 23.9974C15.4756 23.9974 18.205 22.9348 20.1936 21.1005L16.3266 18.1021C15.2507 18.8341 13.8618 19.2486 12.2435 19.2486C9.11291 19.2486 6.45849 17.1365 5.50607 14.2969H1.51562V17.3878C3.55274 21.44 7.70192 23.9974 12.2391 23.9974Z"
          fill="#34A853"
        ></path>
        <path
          d="M5.50473 14.3027C5.00206 12.8123 5.00206 11.1985 5.50473 9.70813V6.61719H1.51869C-0.183313 10.008 -0.183313 14.0028 1.51869 17.3936L5.50473 14.3027Z"
          fill="#FBBC04"
        ></path>
        <path
...
export function IconMic({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
