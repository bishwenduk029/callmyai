  ...
  (
    ...
    return (
      <textarea
        ...
        ref={textAreaRef}
        className={cn(
          'flex w-full text-foreground rounded-md bg-background px-3 py-2 text-lg placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
          className,
        )}
        onChange={(e) => {
