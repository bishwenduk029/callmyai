...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-16 items-center justify-center rounded-full border-2 border-border bg-background p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function AnimatedBeamMultipleDataSources({
  className,
}: {
  className?: string
}) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-start sm:items-center justify-start overflow-hidden rounded-lg bg-background sm:p-10",
        className
      )}
      ref={containerRef}
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-4 sm:gap-10 max-w-[300px] sm:max-w-lg">
