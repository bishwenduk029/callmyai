...
export function AnimatedBeamActions({
  className,
}: {
  className?: string
}) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-start sm:items-center justify-start overflow-hidden sm:rounded-lg bg-background sm:p-10",
        className
      )}
      ref={containerRef}
    >
